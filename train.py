...
from mypath import Path #V
from dataloaders import make_data_loader #V
from modeling.sync_batchnorm.replicate import patch_replication_callback
from modeling.deeplab import *
from utils.loss import SegmentationLosses
from utils.calculate_weights import calculate_weigths_labels
from utils.lr_scheduler import LR_Scheduler
from utils.saver import Saver #V
from utils.summaries import TensorboardSummary #V
    ...
    def __init__(self, args):
        ...
        if args.use_balanced_weights:
            ...
            if os.path.isfile(classes_weights_path):
                ...
                weight = calculate_weigths_  s(args.dataset, self.train_loader, self.nclass)
